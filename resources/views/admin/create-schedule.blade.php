...
@section('content')
    <h1 class="text-3xl font-bold mb-6">Create Schedule</h1>

    <form action="{{ route('admin.schedule.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
