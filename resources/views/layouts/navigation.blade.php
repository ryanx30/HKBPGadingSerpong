<nav x-data="{ open: false }" class="bg-[#2e1010] dark:bg-[#2e1010] border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden space-x-8 sm:flex">
                ...
                <x-nav-link :href="route('ministries')" :active="request()->routeIs('ministries')">
                    {{ __('Ministries') }}
                </x-nav-link>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ministries')" :active="request()->routeIs('ministries')">
                {{ __('Ministries') }}
            </x-responsive-nav-link>
        </div>
